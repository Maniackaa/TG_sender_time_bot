...
def test_high_volatility(
    ...
    for key, new_val_list in sms_new.items():
        ...
        if len(old_val_list) == 1 == len(new_val_list):
...
# #
old = {'GAZ': [500.0], 'BRENT': [78.315], 'OIL': [0.2], 'US': [0.8], 'EU': [0.6, 0.5], 'EUR': [1.083], 'EURRUB': [83.33], 'RUR': [76.93], 'GAZP': [170.3], 'SBER': [213.7], 'AFLT': [32.3], 'GMKN': [14.335], 'ROSN': [379.1], 'NLMK': [128.4], 'CHMF': [1057.4], 'NVTK': [1155.8], 'SNGS': [23.54], 'SNGSP': [31.3], 'VTB': [0.0183], 'MTSS': [257.2], 'RNFT': [104.8]}
...
x = test_high_volatility(old, new)
print(x)